...
var g = (e, t) => {
  switch (t.type) {
    ...
    case 1:
      return t.toast.id && M(t.toast.id), { ...e, toasts: e.toasts.map((r) => r.id === t.toast.id ? { ...r, ...t.toast } : r) };
    case 2:
      let { toast: o } = t;
      return e.toasts.find((r) => r.id === o.id) ? g(e, { type: 1, toast: o }) : g(e, { type: 0, toast: o });
    case 3:
      let { toastId: n } = t;
      return n ? b(n) : e.toasts.forEach((r) => {
        b(r.id);
      }), { ...e, toasts: e.toasts.map((r) => r.id === n || n === void 0 ? { ...r, visible: false } : r) };
    case 4:
    ...
    case 6:
      ...
      return { ...e, pausedAt: void 0, toasts: e.toasts.map((r) => ({ ...r, pauseDuration: r.pauseDuration + s })) };
  }
};
var f = [];
...
var O = (e = {}) => {
  let [t, o] = (0, import_react.useState)(S);
  (0, import_react.useEffect)(() => (f.push(o), () => {
    let s = f.indexOf(o);
    s > -1 && f.splice(s, 1);
  }), [t]);
  let n = t.toasts.map((s) => {
    var r, c;
    return { ...e, ...e[s.type], ...s, duration: s.duration || ((r = e[s.type]) == null ? void 0 : r.duration) || (e == null ? void 0 : e.duration) || U[s.type], style: { ...e.style, ...(c = e[s.type]) == null ? void 0 : c.style, ...s.style } };
  });
  return { ...t, toasts: n };
};
...
var H = (e) => {
  ...
  }, [o]), s = (0, import_react2.useCallback)((r, c) => {
    let { reverseOrder: i = false, gutter: d = 8, defaultPosition: P } = c || {}, A = t.filter((u) => (u.position || P) === (r.position || P) && u.height), _ = A.findIndex((u) => u.id === r.id), D = A.filter((u, y) => y < _ && u.visible).length;
